...
export default function ResultPage() {
  ...
  const verificationData = [
    ...
    },
    {
      ...
      utilization: Math.round(
        (obtainedValues.separationLoad / limits.separationLoad) * 100,
      ),
  ...
  return (
    <>
              ...
              <div className="p-3 sm:p-4 md:p-5">
                <div className="flex justify-center py-4 sm:py-6 bg-slate-50 dark:bg-slate-950 rounded-lg mb-4 sm:mb-6 border border-dashed border-slate-200 dark:border-slate-800">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M7 2h10l1 3v2h-12V5l1-3zM5 7h14v2H5V7zM7 9h10v10l-2 3H9l-2-3V9z"></path>
                    <path
                ...
                <dl className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <dd className="font-medium font-mono text-primary text-sm sm:text-base">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 border border-primary/30 dark:border-primary/40 rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 shadow-lg shadow-primary/5 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 overflow-hidden relative">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full md:w-auto shrink-0 relative z-0">
                ...
                <button className="w-full sm:w-auto sm:flex-1 md:flex-none px-4 sm:px-6 py-2 sm:py-2.5 bg-primary text-white rounded-lg text-xs sm:text-sm font-semibold hover:bg-primary/90 transition-all shadow-md shadow-primary/20 whitespace-nowrap">
                  Save Calculation
                </button>
              </div>
            </div>
      ...
      {/* Footer */}
      <footer className="mt-8 sm:mt-12 py-6 sm:py-8 border-t border-slate-200 dark:border-slate-800 text-center px-4">
